...
def parse_url(url):
    ...
    model = load_model(os.path.join(path,'models','JORN-12.tf'))
    ...
    dwc_det = {
            ...
            "identificationReferences" : "ID used the JORN-12 carabid model",
    ...
    #write output to log file
    log_file = os.path.join(path,'logs','JORN-12.log')
